...
This version is compatible with older nbclient versions (imports CellExecutionError from nbclient.exceptions).
...
Requirements:
  pip install -U nbclient nbformat
"""
...
# nbclient compatibility imports
try:
    ...
    try:
        ...
        # Fallback: define a dummy to catch generic Exception instead
        class CellExecutionError(Exception):
            pass

import traceback

DEFAULT_NB = "NoteBooks\Retina_SEM_SLED_Debug.ipynb"
